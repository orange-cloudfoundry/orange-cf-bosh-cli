...
display "kube-editor" "Set read-only/read-write kubectl editor mode"
display "kube-tail/kt" "Tail on kubernetes logs"
display "kustomize" "Kubernetes template customize YAML files tool"
display "kyverno" "Kubernetes policy engine tool"
display "k9s" "Cluster manager cli"
display "k9s-mode" "Set read-only/read-write k9s mode"
