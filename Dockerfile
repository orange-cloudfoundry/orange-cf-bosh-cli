...
ENV ARGO_VERSION="3.7.1" \
    ...
    CNPG_VERSION="1.27.0" \
    CREDHUB_VERSION="2.9.49" \
    CROSSPLANE_CLI="1.19.2" \
    FLUX_VERSION="2.5.1" \
    FLY_VERSION="7.11.2" \
    GITLAB_VERSION="1.67.0" \
    GITHUB_VERSION="2.78.0" \
    GOSS_VERSION="0.4.9" \
    GOVC_VERSION="0.52.0" \
    HELM_VERSION="3.17.1" \
