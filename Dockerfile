...
ENV ARGO_VERSION="3.7.6" \
    ...
    CNPG_VERSION="1.28.0" \
    CREDHUB_VERSION="2.9.52" \
    CROSSPLANE_CLI="2.0.2" \
    FLUX_VERSION="2.7.3" \
    FLY_VERSION="7.14.3" \
    GITLAB_VERSION="1.80.4" \
    GITHUB_VERSION="2.83.2" \
    GOSS_VERSION="0.4.9" \
    GOVC_VERSION="0.52.0" \
    HELM_VERSION="3.17.1" \
