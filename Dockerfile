...
ENV ARGO_VERSION="3.7.9" \
    ...
    CNPG_VERSION="1.28.0" \
    CREDHUB_VERSION="2.9.53" \
    CROSSPLANE_CLI="2.1.3" \
    FLUX_VERSION="2.7.3" \
    FLY_VERSION="7.14.3" \
    GITLAB_VERSION="1.82.0" \
