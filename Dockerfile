...
RUN printf '\n=====================================================\n Install system packages\n=====================================================\n' && \
    ...
    printf '\n=> Add OC-CLI\n' && curl -sSL "https://downloads-openshift-console.apps.rh-gcp-csf.a3rr.p2.openshiftapps.com/amd64/linux/oc.tar"| tar -x -C /tmp && mv /tmp/oc /usr/local/bin/oc && /usr/local/bin/oc completion bash > /etc/bash_completion.d/oc && \
