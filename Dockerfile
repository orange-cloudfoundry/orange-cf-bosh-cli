...
RUN printf '\n=====================================================\n=> Install system packages\n=====================================================\n' && \
    ...
    printf "  * bosh-gen (${BOSH_GEN_VERSION}) - Bosh package generation (https://github.com/cloudfoundry-community/bosh-gen)\n" >> /etc/motd && \
    ...
    printf "  * yarn (${YARN_VERSION}) - Package manager (https://yarnpkg.com/fr/)\n" >> /etc/motd && \
    printf 'Admin tools:\n' >> /etc/motd && \
